package com.wj.activiti.model.service;
...
/**
 * @PackageName: com.wj.activiti.util
 * @ClassName: ActUtils
 * @Description: ActUtils
 * @Author: Winjay
 * @Date: 2022-10-15 20:31:44
 */
@Component
public class ActivitiService {
     ...
     */
    public void setSequenceFlowCondition(String modelId,String nodelId ,String condition) throws IOException {
        //获取模型--设置连线条件 到 流程中
        ...
        if(!(flowElement instanceof SequenceFlow)){
            throw new RuntimeException("不是连线，不能设置条件");
        }
     ...
     * @return
     */
    public List<PvmActivity> getNextActNodes(String defid, String nodelId, Map<String,Object> elMap){
     ...
     * @return
     */
    public List<PvmActivity> getNextActivities(List<PvmTransition> pvmTransitions,Map<String,Object> elMap){
        List<PvmActivity> pvmActivities=new ArrayList<PvmActivity>();
     ...
     * @return
     */
    public List<PvmTransition> getNextActivities(List<PvmTransition> pvmTransitions){
     ...
     * @param nodelId 节点id
     */
    public List<PvmTransition> getNextPvmTransitions(String defId,String nodelId){
     ...
     * @return
     */
    public ActivityImpl getCurrenActivitiy(String processDefinitionKey,String activitiId){
     ...
     * @return
     */
    public Map<String,Object> getParallelGateways(String taskId){
     ...
     * @return
     */
    private List<PvmTransition> forCheckQueryPvm(List<PvmTransition> pvmTransitions,List<PvmTransition> pvmTransitionList){
     ...
     * @throws Exception
     */
    private void startParallelGateways(Map map,ProcessInstance processInstance,Map<String, Object> variables,String activityId,String comment) throws Exception {
        List<Task> taskList;
     ...
     * @throws Exception
     */
    private void parallelgateway_end(String taskId,  Map<String, Object> variables ) throws Exception {
        // 当前节点
     ...
     * @throws Exception
     */
    private void endParallelGateways(Map map,ProcessInstance processInstance,Map<String, Object> variables,List<String> list,String comment) throws Exception {
     ...
     * @throws Exception
     */
    private void comment(Map map,ProcessInstance processInstance,Map<String, Object> variables,String activityId,String comment) throws Exception {
        List<Task> taskList = new ArrayList<Task>();
        Iterator it=map.keySet().iterator();
        while (it.hasNext()){
            String id = (String) it.next();
     ...
     * @throws Exception
     */
    private void turnTransition(String taskId, List<String> activityIds, Map<String, Object> variables ,String comment) throws Exception {
        // 当前节点
        ActivityImpl currActivity = findActivitiImpl(taskId, null);
        // 清空当前流向
        List<PvmTransition> oriPvmTransitionList = clearTransition(currActivity);
     ...
     * @throws Exception
     */
    public void turnTransition(String taskId, String activityId, Map<String, Object> variables ,String comment) throws Exception {
        // 当前节点
        ActivityImpl currActivity = findActivitiImpl(taskId, null);
        // 清空当前流向
        List<PvmTransition> oriPvmTransitionList = clearTransition(currActivity);
     ...
     * @return
     */
    public String getProActivityId(String processDefinitionKey,String activitiId,String processInstanceId,String preNodeId){
        List<PvmActivity> pvmActivities=new ArrayList<PvmActivity>();
        ProcessDefinition processDefinition = repositoryService.createProcessDefinitionQuery().processDefinitionKey(processDefinitionKey).latestVersion().singleResult();
        ProcessDefinitionEntity def = (ProcessDefinitionEntity) ((RepositoryServiceImpl)repositoryService).getDeployedProcessDefinition(processDefinition.getId());
        List<ActivityImpl> activitiList = def.getActivities();
     ...
     * @return
     */
    public PvmActivity getExclusiveActiviti(PvmActivity ac,String processDefinitionKey,String processInstanceId){
